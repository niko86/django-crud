...
class AttModel(models.Model):
    ...
    oven = models.CharField(verbose_name='Oven used', max_length=7, choices=OVEN_CHOICES, default='OVE-001')
    oven_temp = models.IntegerField(verbose_name='Oven temperature in degrees celcius', default=105)
